...
description: Generate income statements, balance sheets, and cash flow statements with GAAP presentation and period-over-period comparison. Use when preparing financial statements for reporting or filing, running flux/variance analysis between periods, or creating P&L reports with variance commentary. Focuses on financial reporting standards and statement formatting rather than day-to-day accounting operations.
---
