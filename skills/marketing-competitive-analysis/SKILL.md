...
label: 营销竞品分析
description: 调研竞品并对比定位、信息传递、内容策略和市场表现。适用于竞品分析、构建竞争卡片、识别内容缺口、对比功能宣传或准备竞争定位建议。
---
...
- **Community forums**: community forums (e.g. Reddit, Discourse), industry chat groups (e.g. 飞书 IM communities) — user sentiment
