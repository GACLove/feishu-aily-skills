---
name: audit-support
description: Support SOX 404 compliance with control testing methodology, sample selection (random, systematic, targeted), sample size determination by frequency (annual, quarterly, monthly, weekly, daily), and documentation standards. Use when generating testing workpapers, selecting audit samples, determining sample sizes for controls of different frequencies, classifying control deficiencies, or preparing for internal or external audits.
---
