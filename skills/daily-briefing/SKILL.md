...
name: daily-briefing
label: 每日销售简报
description: 提供每日优先级排序的销售简报。独立使用时需手动输入会议和优先事项，接入日历、CRM 和邮件后效果更佳。触发词：「晨间简报」「今日安排」「帮我准备今天的工作」。
---
...
│  + 飞书日历: auto-pull today's meetings with attendees          │
...
|-----------|--------------|
| **飞书日历** | Today's meetings with attendees, times, and context |
...
3. Today's Meetings — From 飞书日历 or user input
...
1. **Connect your 飞书日历 first** — Biggest time saver
