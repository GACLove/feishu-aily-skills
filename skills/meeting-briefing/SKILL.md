...
label: 会议简报
description: 为具有法律相关性的会议准备结构化简报并跟踪行动项。适用于合同谈判、董事会会议、合规审查或任何需要法律背景、调研资料或行动跟踪的会议。
---
...
Determine the meeting context from the user's request or 飞书日历:
...
2. **Set 飞书日历 reminders** for deadlines
